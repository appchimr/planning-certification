...
async function refreshPublic(){
  try{
    ...
    setConnectionStatus(
      "Données à jour — source centrale Communication CHIMR",
      "ok"
    );
    ...
    if(el){
      el.textContent =
        `Dernière actualisation : ${d.toLocaleString("fr-FR")}`;
    }
    ...
    setConnectionStatus(
      "Impossible de joindre la sauvegarde centrale",
      "bad"
    );
